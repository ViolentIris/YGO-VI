...
void Game::DrawCard(ClientCard* pcard) {
	...
	if(!dInfo.isReplay && dInfo.player_type < 7) {
	    driver->draw2DImage(imageManager.tHead[0], Resize(328, 60, 408, 140, 328, 60), recti(0, 0, 160, 160), 0, 0, true);
		driver->draw2DImage(imageManager.tHead[1], Resize(910.5, 60, 990.5, 140, 990.5, 140), recti(0, 0, 160, 160), 0, 0, true);
	} else {
	    driver->draw2DImage(imageManager.tHead[0], Resize(328, 60, 408, 140, 328, 60), recti(0, 0, 160, 160), 0, 0, true);
		driver->draw2DImage(imageManager.tHead[1], Resize(910.5, 60, 990.5, 140, 990.5, 140), recti(0, 0, 160, 160), 0, 0, true);
	}
...
void Game::DrawMisc() {
	...
	if(!dInfo.isReplay && dInfo.player_type < 7 && dInfo.time_limit) {
		...
		driver->draw2DImage(imageManager.tHead[0], Resize(541, 32, 559, 50, 559, 41), rect<s32>(0, 0, 160, 160), 0, 0, true);
		driver->draw2DImage(imageManager.tHead[1], Resize(746, 32, 764, 50, 764, 41), rect<s32>(0, 0, 160, 160), 0, 0, true);
